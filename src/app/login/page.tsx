            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 pr-10 text-black border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
